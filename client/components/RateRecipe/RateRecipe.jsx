...
import style from './RateRecipe.scss';

class RateRecipe extends React.PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <ReactModal
        ...
        <div className={theme.rate_recipe}>
...
export default themr('RateRecipe', style)(RateRecipe);
